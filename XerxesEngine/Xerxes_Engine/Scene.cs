...
namespace Xerxes_Engine
{
    public class Scene
    {
        ...
        internal void BeginRender(Render_Service renderService)
            => HandleBeginRender(renderService);
        /// <summary>
        /// Returns the desired shader ID.
        /// </summary>
        /// <returns></returns>
        protected virtual void HandleBeginRender(Render_Service renderService) { }

        internal void RenderScene(Render_Service renderService, Frame_Argument e) 
        ...
        /// <param name="e"></param>
        protected virtual void Handle_RenderScene(Render_Service renderService, Frame_Argument e)
        {
            foreach(Scene_Layer layer in sceneLayers)
            {
