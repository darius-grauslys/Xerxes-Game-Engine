...
namespace Xerxes_Engine.UI
{
    public class UI_Rect
    {
        ...
        internal void Set__Scaling_Vector__UI_Rect(Vector2 newSize)
            => UI_Rect__Scaling_Vector = Math_Helper.Get__Safe_Normalized(newSize);
        
        public float Get__Hypotenuse__UI_Rect()
            => Math_Helper.Get__Hypotenuse(UI_Rect__Size);
        ...
        public float Get__Initial_Hypotenuse__UI_Rect()
            => Math_Helper.Get__Hypotenuse(UI_Rect__INITIAL_SIZE);
        ...
        /// Use this for proper positioning of UI_Game_Objects.
        /// [_UI_Rect__Position]
        /// </summary>
        /// <returns></returns>
        ...
        /// Use this for rendering graphics of UI_Game_Objects - NOT - for proper positioning.
            ...
            )
        {
            ...
            Vector2 usedSize = Math_Helper.Clamp__Vector2_UFloat(new Vector2(width, height));
        ...
        {
            float clampedHypotenuse = Math_Helper.Clamp__Float
            (
                hypotenuse,
                UI_Rect__Min_Hypotenuse,
                UI_Rect__Max_Hypotenuse
        ...
        {
            newSize = Math_Helper.Clamp__Vector2_UFloat(newSize);

            UI_Rect__Scaling_Vector = newSize.Normalized();
            
            Internal_Rescale__UI_Rect(Math_Helper.Get__Hypotenuse(newSize));
        }
        ...
        )
        {
            ...
            float hyp_w = Math_Helper.Get__Hypotenuse(w_delta_outscribed);
            float hyp_h = Math_Helper.Get__Hypotenuse(h_delta_outscribed);

            float hyp_inscribed = Math_Helper.Get__Hypotenuse(dist_Inscribed);

            bool bound_w = Math_Helper.Tolerable__LessThan__Float(hyp_inscribed, hyp_w);
            bool bound_h = Math_Helper.Tolerable__LessThan__Float(hyp_inscribed, hyp_h);
        ...
        )
        {
            ...
            bool isBounded = Math_Helper.CheckIf__Vec_Is_Bounded__Forth_Quadrant
            (
                offsetPosition,
                logicalBounds[0],
                logicalBounds[1]
