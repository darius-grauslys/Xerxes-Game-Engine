    ...
    public class Animation_Render_Component : Sprite_Render_Component 
    {
            ...
            double loopDelay=-1)
        {
            if (speed < -1)
            {
                ...
                (
                    Log_Messages__OpenTK.WARNING__ANIMATION_RENDER_COMPONENT__BAD_NEGATIVE_SPEED_1,
                    this,
                    speed
                );
            }
        ...
        )
        {
            ...
            {
                Private_Log_Error_Error__Node_Definition_Out_Of_Bounds
                (
                    this,
                    nodeIndex,
...
#region Static Logging
        private static void Private_Log_Error_Error__Node_Definition_Out_Of_Bounds
        (
        ...
        )
        {
            ...
            (
                ...
                Log_Messages__OpenTK.ERROR__ANIMATION__NODE_DEFINITION__OUT_OF_BOUNDS_2,
                source,
                index,
                count
            );
