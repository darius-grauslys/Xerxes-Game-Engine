...
{
    /// <summary>
    /// The channel used to relay information of a key becoming down or up.
    /// </summary>
    public class KeyboardKeystateEventChannel : EventChannel
    {
        ...
        {
            Send(sender, args as KeyboardPressEventArgument);
        }
